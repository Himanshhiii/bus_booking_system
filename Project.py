...
def new_run():
    ...
    Label(f17,text = "Bus Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
...
def new_route():
    ...
    Label(f15,text = "Bus Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
...
def new_bus():
    ...
    Label(f13,text = "Bus Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
...
def new_operator():
    ...
    Label(f11,text = "Bus Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
...
def ticketShow(row):
    ...
    Label(f4,text = "Bus Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red').grid(row=1,column=0,columnspan=5)
...
def check_booked_seat(f2):
    ...
    Label(f7,text = "Bus Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red',anchor=CENTER ).grid(row=1,column=0,columnspan=5)
...
def add_bus():
    ...
    Label(f9,text = "Bus Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red',anchor=CENTER ).grid(row=1,column=0,columnspan=5)
...
def tab2():
    ...
    Label(f2,text = "Bus Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red',anchor=CENTER ).grid(row=1,column=0,columnspan=5)
    f3 =Frame(f2,pady=20)
...
def tab1():
    ...
    Label(f1,text = "Bus Service", font=("Arial",25), bg = 'deep sky blue', fg = 'red' ).pack()
